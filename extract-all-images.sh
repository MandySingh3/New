...
sudo umount $OUTPUT_DIR/product
...
sudo umount $OUTPUT_DIR/system_ext
...
sudo umount $OUTPUT_DIR/aop_config
...
sudo cp -r $OUTPUT_DIR/bluetooth/* $OUTPUT_DIR/
sudo umount $OUTPUT_DIR/bluetooth
...
sudo umount $OUTPUT_DIR/cpucp_dtb
...
# Extract the engineering_c dt image contents
sudo cp -r $OUTPUT_DIR/engineering_cdt/* $OUTPUT_DIR/
sudo umount $OUTPUT_DIR/engineering_cdt
...
sudo umount $OUTPUT_DIR/featenabler
...
sudo umount $OUTPUT_DIR/imagefv
...
sudo umount $OUTPUT_DIR/init_boot
...
sudo umount $OUTPUT_DIR/keymaster
...
sudo umount $OUTPUT_DIR/my_bigball
...
sudo umount $OUTPUT_DIR/my_carrier
...
sudo umount $OUTPUT_DIR/my_engineering
...
sudo umount $OUTPUT_DIR/my_heytap
...
sudo umount $OUTPUT_DIR/my_manifest
...
sudo umount $OUTPUT_DIR/my_product
...
sudo umount $OUTPUT_DIR/my_region
...
sudo umount $OUTPUT_DIR/my_stock
...
sudo umount $OUTPUT_DIR/oplus_sec
...
sudo umount $OUTPUT_DIR/oplusstanv_bk
...
sudo umount $OUTPUT_DIR/recovery
...
sudo umount $OUTPUT_DIR/system_dlkm
...
sudo umount $OUTPUT_DIR/uefisecapp
...
sudo umount $OUTPUT_DIR/vbmeta_system
...
sudo umount $OUTPUT_DIR/vbmeta_vendor
...
sudo umount $OUTPUT_DIR/vendor_boot
...
sudo umount $OUTPUT_DIR/vendordlkm
...
sudo umount $OUTPUT_DIR/xbl_config
...
sudo umount $OUTPUT_DIR/xbl_ramdump
